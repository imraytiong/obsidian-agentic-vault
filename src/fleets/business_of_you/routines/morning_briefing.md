...
4. Pass this raw daily execution plan to the **Executive Coach** to generate high-impact daily "Coaching Reminders".
5. Read `Daily_Briefing_Template.md` from the `templates` zone.
6. Synthesize all this information (including the coaching reminders) and save it as a unified markdown note inside the `briefings` zone named `YYYY-MM-DD_Daily_Note.md`.
